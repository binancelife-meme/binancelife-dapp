...
export const AvaxLogo = ({ size = DefaultSize }: { size?: IconSize }) => (
  <svg
    width={size.width}
    height={size.height}
    viewBox="0 0 30 30"
...
export const BNBLogo = ({ size = DefaultSize }: { size?: IconSize }) => (
  <svg
    width={size.width}
    height={size.height}
    viewBox="0 0 30 30"
...
export const BNBChainIcon = ({
  ...
  <Icon
    ...
    height={size.width}
    width={size.height}
    icon="simple-icons:bnbchain"
  />
);

export const ETHCoin = ({ size = DefaultSize }: { size?: IconSize }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size.width}
    height={size.height}
...
export const ETHLogo = ({ size = DefaultSize }: { size?: IconSize }) => (
  <svg
    width={size.width}
    height={size.height}
    viewBox="0 0 30 30"
...
export const PolygonLogo = ({ size = DefaultSize }: { size?: IconSize }) => (
  <svg
    width={size.width}
    height={size.height}
    viewBox="0 0 30 30"
