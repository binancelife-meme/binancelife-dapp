...
import { Currency, Token, NativeCurrency } from '@/constants/tokens/_base'
import { WNATIVE, NATIVE } from '@/constants/tokens/chains/constants'
...
export class Native extends NativeCurrency {
  ...
  public static onChain(chainId: number): Native {
    ...
    invariant(!!NATIVE[chainId as keyof typeof NATIVE], `NATIVE_CURRENCY > ${chainId}`)
